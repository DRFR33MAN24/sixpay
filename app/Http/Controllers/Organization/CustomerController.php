...
class CustomerController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect(route('organization.customer.list'));
    }
    ...
    public function add_tags(Request $request)
    {
        ...
        return redirect(route('organization.customer.tags-list'));
    }
    ...
    public function tagsList(Request $request)
    {
        ...
        return view('organization-views.customer.tags_list', compact('tags', 'search'));
    ...
    public function edit_tag($id): Factory|View|Application
    {
        ...
        return view('organization-views.customer.tags_edit', compact('tag'));
    }
          /**
     * @param $id
     * @return Application|Factory|View
    ...
    {
       // Log::info(auth()->user()->organization->id);
        $queryParams = [];
        $search = $request['search'];
        if ($request->has('search')) {
            $key = explode(' ', $request['search']);
            ...
            $customers = $this->user->where('org_id',auth()->user()->organization->id);
           
        }

        $customers = $customers->latest()->customer()->paginate(Helpers::pagination_limit())->appends($queryParams);
        return view('organization-views.customer.list', compact('customers', 'search'));
    }
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'view' => view('organization-views.customer.partials._table', compact('customers'))->render(),
        ]);
    }
    ...
    public function view($id): Factory|View|Application
    {
        ...
        return view('organization-views.view.details', compact('user'));
    }
    ...
    public function transaction(Request $request, $id): Factory|View|Application
    {
        ...
        return view('organization-views.view.transaction', compact('user', 'transactions', 'search'));
    }
    ...
    public function log(Request $request, $id): View|Factory|Application
    {
        ...
        $user = $this->user->find($id);
        return view('organization-views.view.log', compact('user', 'userLogs', 'search'));
    }
    ...
    public function getKycRequest(Request $request): Factory|View|Application
    {
        ...
        return view('organization-views.customer.kyc_list', compact('customers', 'search'));
    }
