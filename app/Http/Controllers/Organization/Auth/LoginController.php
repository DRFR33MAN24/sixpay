...
class LoginController extends Controller
{
    ...
    public function login(Request $request): Factory|View|Application
    {
        ...
        return view('organization-views.auth.login', compact('currentUserInfo'));
    }
    ...
    public function submit(Request $request): RedirectResponse
    {
        ...
        if (auth('user')->attempt(['phone' => $phone, 'password' => $request->password, 'type' => ORGANIZATION_TYPE], $request->remember)) {
    ...
    public function logout(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('organization.auth.login');
    }
}
