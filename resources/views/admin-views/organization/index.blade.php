...
@section('title', translate('Add New Organization'))

@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{asset('public/assets/admin/img/media/store.png')}}" alt="{{ translate('organization') }}">
            <h2 class="page-header-title">{{translate('Add New Organization')}}</h2>
        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center mt-3">
                                <img class="border rounded-10 w-200" id="viewer"
                                        src="{{asset('public/assets/admin/img/400x400/img2.jpg')}}" alt={{ translate('organization') }}/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
