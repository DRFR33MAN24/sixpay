        ...
        <div class="card">
            <div class="card-header __wrap-gap-10">
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="{{route('organization.customer.add')}}" class="btn btn-primary">
                ...
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table with-100-percent">
                    ...
                    @foreach($customers as $key=>$customer)
                        <tr>
                            ...
                            <td>
                                <a class="media gap-3 align-items-center text-dark" href="{{route('organization.customer.view',[$customer['id']])}}">
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    href="{{route('organization.customer.view',[$customer['id']])}}">
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </a>
                                    @if($customer['is_kyc_verified'] == 0)
                                        <a class="action-btn btn btn-outline-success"
                                        href="{{route('organization.customer.kyc_status_update',[$customer['id'], 1])}}">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </a>
                                        <a class="action-btn btn btn-outline-danger"
                                        href="{{route('organization.customer.kyc_status_update',[$customer['id'], 2])}}">
