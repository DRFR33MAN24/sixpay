                    ...
                    <div class="table-responsive datatable-custom">
                        <table
                            ...
                            @forelse($transactions as $key=>$transaction)
                                @php($route = [0 => 'admin', 1 => 'agent', 2 => 'customer', 3 => 'merchant',4=>'organization'])
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($sender_info != null)
                                            <a href="{{route('organization.'. $route[$sender_info->type] .'.view',[$transaction['from_user_id']])}}">
                                    ...
                                    <td>
                                        ...
                                        @if($receiver_info != null)
                                            <a href="{{route('organization.'. $route[$receiver_info->type] .'.view',[$transaction['to_user_id']])}}">
