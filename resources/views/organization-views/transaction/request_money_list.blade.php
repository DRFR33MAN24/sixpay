                            ...
                            <td>
                                ...
                                @if(isset($user))
                                    <span class="d-block font-size-sm text-body">
                                        <a href="{{route('organization.customer.view',[$user->id])}}">
                                ...
                                @if(isset($user))
                                    @if( $items->type == 'pending' )
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('organization.transaction.request_money_status_change', ['approve', 'id'=>$items->id]) }}" class="btn btn-primary btn-sm"> {{translate('Approve')}}</a>
                                            <a href="{{ route('organization.transaction.request_money_status_change', ['deny', 'id'=>$items->id]) }}" class="btn btn-warning btn-sm"> {{translate('Deny')}}</a>
                                        </div>
